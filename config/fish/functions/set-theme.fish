function _generate_gtk_css -d "Generate CSS for GTK themes from pywal JSON"
...
function _check_dependencies -d "Check if required tools are available"
    set -l missing_tools
